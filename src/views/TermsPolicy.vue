<template>
  <div>
    <!-- Breadcrumb -->
    <section class="section-breadcrumb" id="iyong">
    ...
    <section>
      <div class="container">
        ...
        <div class="cr-breadcrumb-title" >
          ...
          <div class="col-12 iyong d-flex justify-content-center">
            <textarea class="col-12" style="resize: none">
제1조(목적)
...
제18조(“몰“의 의무)
 ...
 ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
    ...
    <!-- Breadcrumb -->
    <section class="section-breadcrumb" id="gaein">
      <div class="cr-breadcrumb-image">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
    ...
    <section style="padding-top: 25px; padding-bottom: 100px">
      <div class="container">
        <div class="row">
         <div class="cr-breadcrumb-title" >
                <h2 style="font-weight: bold">개인정보처리방침</h2>
              </div>
          <div class="col-12 iyong d-flex justify-content-center">
            <textarea class="col-12" style="resize: none">
