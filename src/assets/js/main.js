(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".ssm-toggle a").on("click", function () {
        ...
        var toggleHeader = function (crDirection, crCurScroll) {
            ...
            if (crDirection === 2 && crCurScroll > -46) {
                ...
                $("#ssm-main-menu-desk").addClass("menu_fixed_up");
            } else if (crDirection === 1) {
                crPrevDirection = crDirection;
                $("#ssm-main-menu-desk").addClass("menu_fixed");
                $("#ssm-main-menu-desk").removeClass("menu_fixed_up");
            }
        };
        ...
        $(window).on("scroll", function () {
            ...
            if ($window.scrollTop() <= distance + 5) {
                $("#ssm-main-menu-desk").removeClass("menu_fixed");
            } else {
                checkScroll();
            }
        });
    ...
    //             $("#startRangePrice").val( ui.values[0].toLocaleString('ko-KR'));
    //             $("#endRangePrice").val( ui.values[1].toLocaleString('ko-KR'));
    //         },
    //     });
    //     $("#startRangePrice").val(
    ...
    $(".ssm-sidebar-overlay, .ssm-close").on("click", function () {
